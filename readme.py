...
class ReadMeDialog(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("ReadMe") # Name of the pop-window
        self.resize(600, 400) # Initial Size. Thankfully Qt6 makes everything dynamic re-sizeable.
        self.layout = QtWidgets.QVBoxLayout(self)
        self.text_edit = QtWidgets.QTextBrowser(self) #QTextBrowser means user can't type here
        self.layout.addWidget(self.text_edit) # Finish layout

    def set_readme_contents(self, contents):
...
def open_readme_dialog():
    dialog = ReadMeDialog() # Initialising
    # Set the contents of the ReadMe dialog here
    readme_contents = """
    # Data Cleaning App
    ...
    """
    dialog.set_readme_contents(readme_contents) # Send our whole text to the function
    dialog.show_readme_dialog() # And display
